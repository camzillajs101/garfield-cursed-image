...
Image.create(path: "garsans.jpg", name: "Garçans", nsfw: false)
Image.create(path: "gavel.jpg", name: "Justice", nsfw: false)
...
Image.create(path: "meesa.jpg", name: "Jar Gar", nsfw: false)
...
Image.create(path: "quoi.jpg", name: "Epic", nsfw: false)
...
Image.create(path: "sexiest.jpg", name: "Sexiest", nsfw: false)
